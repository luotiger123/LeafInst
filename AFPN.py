...
class AFPN(nn.Module):
    def __init__(self,
        ...
        self.conv00 = BasicConv(in_channels[0] // 8, out_channels, stride=2, kernel_size=3,pad=1)
        self.conv11 = BasicConv(in_channels[1] // 8, out_channels, stride=2, kernel_size=3,pad=1)
        self.conv22 = BasicConv(in_channels[2] // 8, out_channels, stride=2, kernel_size=3,pad=1)
        self.conv33 = BasicConv(in_channels[3] // 8, out_channels, stride=2, kernel_size=3,pad=1)
        self.conv44 = nn.MaxPool2d(kernel_size=2, stride=2)
